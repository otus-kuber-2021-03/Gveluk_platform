...
Ответ: ReplicaSet не проверяет соответствие запущенных Podов шаблону, а следит только за тем, чтобы число подов соответствовало заданному.

Выполнены основное и все дополнительные задания.
...
HomeTask7: Выполнены все задания без звездочек.